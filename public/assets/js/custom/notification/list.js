...
// let tableEle = document.getElementById('notification-list');
// let notificationDT = new DataTable(tableEle, {
//   responsive: true,
//   // scrollY: "350px",
//   // scrollCollapse: true,
//   dom:
...
// // datatable row click
// notificationDT.on('click', 'tbody tr', function () {
//   let data = notificationDT.row(this).data();
//   changed_notification_detail_url = notification_detail_url.replace('id', data.id);

//   location.href = changed_notification_detail_url;
// });
...
//   notificationDT.search(search.value).draw();
// });